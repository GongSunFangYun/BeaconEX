...
- [ ] 对 modules 软件包而言，其内部的架构和 API 设计以及代码分离做的还是不够完善...
- [ ] 对 dll_injector 模块而言，功能有待扩展...
- [ ] 对 heat_map 模块而言，功能有待扩展...
- [ ] 对 launch_bat 模块而言，功能有待扩展...
- [ ] 对 log_analyzer 模块而言，功能有待扩展...
- [ ] 对 nbt_editor 模块而言，功能需要整合...
- [ ] 对 ping_server 模块而言，功能有待扩展...
- [ ] 对 playerdata_counter 模块而言，功能需要扩展和升级...
- [ ] 对 query_server 模块而言，功能有待扩展...
- [ ] 对 rcon_executor 模块而言，功能有待扩展...
- [ ] 对 world_analyzer 模块而言，功能有待扩展...
- [ ] 对 world_backup 模块而言，功能需要优化...
- [ ] 对所有模块的错误处理进行深化，BeaconEX不能止步于简单的```err```
- [ ] 对于本项目而言，当前的设计不足以构成一个体系，只能说是一个工具集，而不是一个工具链，未来会强化各模块之间的关系和提供专项功能 
